(() => {
  ...
  // work/hp-sofa-updates-accounting-sparse/accounting/src/accounting-core.mjs?v=v8-cost-data-20260703
  ...
  var patch = { versionCode: 12, versionName: "v12-\u624B\u673A\u517C\u5BB9\u8865\u4E01-2026-07-06" };
  ...
  async function init() {
    ...
    state = __spreadProps(__spreadValues({}, await res.json()), { activeId: "nikator-2026", activeYear: "2026", activeMonth: 6 });
    setPhoneFolds();
    bindEvents();
    render();
  }
