const cacheName = "hp-sofa-catalog-v1104-zolano3792-hard-pin";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1104-zolano3792-hard-pin",
  "./app-version.js?v=v1104-zolano3792-hard-pin",
  "./app.js?v=v1104-zolano3792-hard-pin",
  "./manifest.json?v=v1104-zolano3792-hard-pin",
  "./assets/app-icon.svg?v=v1104-zolano3792-hard-pin"
];
