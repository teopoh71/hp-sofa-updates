const cacheName = "hp-sofa-catalog-v1095-native-patch-bridge";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1095-native-patch-bridge",
  "./app-version.js?v=v1095-native-patch-bridge",
  "./app.js?v=v1095-native-patch-bridge",
  "./manifest.json?v=v1095-native-patch-bridge",
  "./assets/app-icon.svg?v=v1095-native-patch-bridge"
];
