...
function getZolano3776GeneratedRecommendations(items) {
  ...
  const showroomNote = "展厅整套：缺 1 table；部分位置为 M/F microfiber";
...
function renderSetPreview() {
  ...
  setPhoto.innerHTML = `
    ...
    <div class="set-photo-copy">
      ...
      ${showroomNote ? `<p class="combo-note"><span>展厅备注</span><strong>${showroomNote}</strong></p>` : ""}
