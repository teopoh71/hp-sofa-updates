const cacheName = "hp-sofa-catalog-v274-zolano-missing-photo-cards-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v274-zolano-missing-photo-cards-local",
  "./app-version.js?v=v274-zolano-missing-photo-cards-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v274-zolano-missing-photo-cards-local",
  ...
  "./zolano-excel-price-overrides.js?v=v274-zolano-missing-photo-cards-local",
  "./zolano-visual-overrides.js?v=v274-zolano-missing-photo-cards-local",
  "./chair-data.js?v=2",
