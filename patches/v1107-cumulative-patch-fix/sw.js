const cacheName = "hp-sofa-catalog-v1107-cumulative-patch-fix";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1107-cumulative-patch-fix",
  "./app-version.js?v=v1107-cumulative-patch-fix",
  "./app.js?v=v1107-cumulative-patch-fix",
  "./manifest.json?v=v1107-cumulative-patch-fix",
  "./assets/app-icon.svg?v=v1107-cumulative-patch-fix"
];
