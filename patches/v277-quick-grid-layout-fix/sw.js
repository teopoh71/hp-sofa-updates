const cacheName = "hp-sofa-catalog-v277-quick-grid-layout-fix-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v277-quick-grid-layout-fix-local",
  "./app-version.js?v=v277-quick-grid-layout-fix-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v277-quick-grid-layout-fix-local",
  ...
  "./zolano-excel-price-overrides.js?v=v277-quick-grid-layout-fix-local",
  "./zolano-visual-overrides.js?v=v277-quick-grid-layout-fix-local",
  "./chair-data.js?v=2",
