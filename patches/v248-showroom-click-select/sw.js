const cacheName = "hp-sofa-catalog-v248-showroom-click-select-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v248-showroom-click-select-local",
  "./app-version.js?v=v248-showroom-click-select-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v248-showroom-click-select-local",
  ...
  "./zolano-visual-overrides.js?v=v248-showroom-click-select-local",
  "./chair-data.js?v=2",
