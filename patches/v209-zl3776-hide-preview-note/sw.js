const cacheName = "hp-sofa-catalog-v209-zl3776-hide-preview-note";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v209-zl3776-hide-preview-note",
  "./app-version.js?v=v209-zl3776-hide-preview-note",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v209-zl3776-hide-preview-note",
  ...
  "./zolano-visual-overrides.js?v=v209-zl3776-hide-preview-note",
  "./chair-data.js?v=2",
