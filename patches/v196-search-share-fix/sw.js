const cacheName = "hp-sofa-catalog-v196-search-share-fix";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v196-search-share-fix",
  "./app-version.js?v=v196-search-share-fix",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v196-search-share-fix",
  ...
  "./zolano-visual-overrides.js?v=v196-search-share-fix",
  "./chair-data.js?v=2",
