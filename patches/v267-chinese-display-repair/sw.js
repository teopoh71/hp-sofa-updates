const cacheName = "hp-sofa-catalog-v267-chinese-display-repair-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v267-chinese-display-repair-local",
  "./app-version.js?v=v267-chinese-display-repair-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v267-chinese-display-repair-local",
  ...
  "./zolano-visual-overrides.js?v=v267-chinese-display-repair-local",
  "./chair-data.js?v=2",
