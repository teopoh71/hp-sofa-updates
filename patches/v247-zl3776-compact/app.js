...
const zolanoModulePhotoMap = Object.fromEntries([...zolano2897Modules, ...zolano3776Modules].map((module) => [module.id, module.photo]));
...
async function maybeClearAppCache() {
  ...
  const clearKey = "hp-sofa-cache-cleared-v247";
