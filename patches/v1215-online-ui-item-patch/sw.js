const cacheName = "hp-sofa-catalog-v1215-online-ui-item-patch";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./silver-star.html?v=v1214-silver-star-catalog",
  "./silver-star.css?v=v1214-silver-star-catalog",
  "./silver-star.js?v=v1214-silver-star-catalog",
  "./silver-star-data.js?v=v1214-silver-star-catalog",
  "./styles.css?v=v1206-stone-select-tableleg-clean",
  "./photo-gallery-viewer.css?v=v1190-native-photo-gallery",
  "./app-version.js?v=v1206-stone-select-tableleg-clean",
  ...
  "./sofa-recommendations.js?v=v1200-showroom-module-highlight",
  "./stone-tabletop-data.js?v=v1206-stone-select-tableleg-clean",
  "./table-leg-data.js?v=v1206-stone-select-tableleg-clean",
  "./app.js?v=v1206-stone-select-tableleg-clean",
  "./stone-tabletop.js?v=v1206-stone-select-tableleg-clean",
