const cacheName = "hp-sofa-catalog-v273-patch-asset-complete-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v273-patch-asset-complete-local",
  "./app-version.js?v=v273-patch-asset-complete-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v273-patch-asset-complete-local",
  ...
  "./zolano-excel-price-overrides.js?v=v273-patch-asset-complete-local",
  "./zolano-visual-overrides.js?v=v273-patch-asset-complete-local",
  "./chair-data.js?v=2",
