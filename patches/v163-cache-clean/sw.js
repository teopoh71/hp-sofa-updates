const cacheName = "hp-sofa-catalog-v162-depth-width-clean";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=156-patch-engine",
  "./app-version.js?v=162-depth-width-clean",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=162-depth-width-clean",
