const cacheName = "hp-sofa-catalog-v1006-table-leg-preview-complete";
...
const appFiles = [
  ...
  "./app-version.js?v=v1006-table-leg-preview-complete",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./clearance-data.js?v=v1003-full-apk-clearance",
  "./table-leg-data.js?v=v1006-table-leg-preview-complete",
  "./app.js?v=v1006-table-leg-preview-complete",
