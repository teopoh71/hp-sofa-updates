const cacheName = "hp-sofa-catalog-v1029-nikator-image-assets";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1029-nikator-image-assets",
  "./app-version.js?v=v1029-nikator-image-assets",
  "./app.js?v=v1029-nikator-image-assets"
];
