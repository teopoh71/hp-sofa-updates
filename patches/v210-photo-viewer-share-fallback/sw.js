const cacheName = "hp-sofa-catalog-v210-photo-viewer-share-fallback";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v210-photo-viewer-share-fallback",
  "./app-version.js?v=v210-photo-viewer-share-fallback",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v210-photo-viewer-share-fallback",
  ...
  "./zolano-visual-overrides.js?v=v210-photo-viewer-share-fallback",
  "./chair-data.js?v=2",
