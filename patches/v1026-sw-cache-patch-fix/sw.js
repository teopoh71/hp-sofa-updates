const cacheName = "hp-sofa-catalog-v1026-sw-cache-patch-fix";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1026-sw-cache-patch-fix",
  "./app-version.js?v=v1026-sw-cache-patch-fix",
  "./app.js?v=v1026-sw-cache-patch-fix"
];
