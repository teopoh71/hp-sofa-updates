const cacheName = "hp-sofa-catalog-v251-old-shell-inject-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v251-old-shell-inject-local",
  "./app-version.js?v=v251-old-shell-inject-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v251-old-shell-inject-local",
  ...
  "./zolano-visual-overrides.js?v=v251-old-shell-inject-local",
  "./chair-data.js?v=2",
