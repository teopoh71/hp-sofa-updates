const cacheName = "hp-sofa-catalog-v1043-gallery-in-apk";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1043-gallery-in-apk",
  "./app-version.js?v=v1043-gallery-in-apk",
  "./app.js?v=v1043-gallery-in-apk"
];
