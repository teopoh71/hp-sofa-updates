...
const currentAppVersion = window.HP_SOFA_APP_VERSION || {
  versionCode: 1038,
  versionName: "v1043-gallery-in-apk",
  ...
  patchversionCode: 1038,
  patchVersionName: "v1043-gallery-in-apk",
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    ...
    navigator.serviceWorker.register("sw.js?v=v1043-gallery-in-apk")
...
async function maybeClearAppCache() {
  ...
  const clearKey = "hp-sofa-cache-cleared-v1043-gallery-in-apk";
