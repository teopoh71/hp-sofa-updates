const cacheName = "hp-sofa-catalog-v272-zolano-excel-showroom-price-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v272-zolano-excel-showroom-price-local",
  "./app-version.js?v=v272-zolano-excel-showroom-price-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v272-zolano-excel-showroom-price-local",
  ...
  "./zolano-excel-price-overrides.js?v=v272-zolano-excel-showroom-price-local",
  "./zolano-visual-overrides.js?v=v272-zolano-excel-showroom-price-local",
  "./chair-data.js?v=2",
