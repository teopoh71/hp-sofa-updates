const cacheName = "hp-sofa-catalog-v1005-table-leg-hard-patch";
...
const appFiles = [
  ...
  "./app-version.js?v=v1005-table-leg-hard-patch",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./clearance-data.js?v=v1003-full-apk-clearance",
  "./table-leg-data.js?v=v1005-table-leg-hard-patch",
  "./app.js?v=v1005-table-leg-hard-patch",
