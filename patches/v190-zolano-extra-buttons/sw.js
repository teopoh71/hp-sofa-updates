const cacheName = "hp-sofa-catalog-v190-zolano-extra-buttons";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v190-zolano-extra-buttons",
  "./app-version.js?v=v190-zolano-extra-buttons",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v190-zolano-extra-buttons",
  ...
  "./zolano-visual-overrides.js?v=v190-zolano-extra-buttons",
  "./chair-data.js?v=2",
