const cacheName = "hp-sofa-catalog-v218-zolano-hard-clean";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v218-zolano-hard-clean",
  "./app-version.js?v=v218-zolano-hard-clean",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v218-zolano-hard-clean",
  ...
  "./zolano-visual-overrides.js?v=v218-zolano-hard-clean",
  "./chair-data.js?v=2",
