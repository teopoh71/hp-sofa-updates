const cacheName = "hp-sofa-catalog-v1175-clearance-chair-photo-fix";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1175-clearance-chair-photo-fix",
  "./app-version.js?v=v1175-clearance-chair-photo-fix",
  "./app.js?v=v1175-clearance-chair-photo-fix",
  "./manifest.json?v=v1175-clearance-chair-photo-fix",
  "./assets/app-icon.svg?v=v1175-clearance-chair-photo-fix"
];
