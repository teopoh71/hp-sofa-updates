const cacheName = "hp-sofa-catalog-v225-show-armchair-models-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v225-show-armchair-models-local",
  "./app-version.js?v=v225-show-armchair-models-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v225-show-armchair-models-local",
  ...
  "./zolano-visual-overrides.js?v=v225-show-armchair-models-local",
  "./chair-data.js?v=2",
...
async function matchPatchCache(request) {
  ...
  if (url.pathname.endsWith("/app.js") || url.pathname.endsWith("/index.html") || url.pathname.endsWith("/")) return null;
