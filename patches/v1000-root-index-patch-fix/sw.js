const cacheName = "hp-sofa-catalog-v1000-root-index-patch-fix";
...
const appFiles = [
  ...
  "./styles.css?v=v1000-root-index-patch-fix",
  "./app-version.js?v=v1000-root-index-patch-fix",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./clearance-data.js?v=v1000-root-index-patch-fix",
  "./app.js?v=v1000-root-index-patch-fix",
  "./assets/individual-item-photos.js?v=v1000-root-index-patch-fix",
  ...
  "./zolano-excel-price-overrides.js?v=v1000-root-index-patch-fix",
  "./zolano-visual-overrides.js?v=v1000-root-index-patch-fix",
  "./chair-data.js?v=2",
  "./bed-data.js?v=125-chinese-materials",
  "./matching-data.js?v=147-bed-size-options",
  "./assets/photo-overrides.js?v=v1000-root-index-patch-fix",
  "./assets/photo-gallery.js?v=v1000-root-index-patch-fix",
  "./assets/entry-gallery.js?v=v1000-root-index-patch-fix",
  "./assets/sofa-asset-gallery.js?v=v1000-root-index-patch-fix",
