const cacheName = "hp-sofa-catalog-v249-force-showroom-ui-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v249-force-showroom-ui-local",
  "./app-version.js?v=v249-force-showroom-ui-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v249-force-showroom-ui-local",
  ...
  "./zolano-visual-overrides.js?v=v249-force-showroom-ui-local",
  "./chair-data.js?v=2",
