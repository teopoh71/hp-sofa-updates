const cacheName = "hp-sofa-catalog-vnikator-whole-photo";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=nikator-all-buttons-share-local",
  "./app-version.js?v=165-photo-longpress",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=nikator-all-buttons-share-local",
  ...
  "./zolano-visual-overrides.js?v=nikator-all-buttons-share-local",
  "./chair-data.js?v=2",
