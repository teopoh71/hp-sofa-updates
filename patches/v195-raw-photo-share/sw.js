const cacheName = "hp-sofa-catalog-v195-raw-photo-share";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v195-raw-photo-share",
  "./app-version.js?v=v195-raw-photo-share",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v195-raw-photo-share",
  ...
  "./zolano-visual-overrides.js?v=v195-raw-photo-share",
  "./chair-data.js?v=2",
