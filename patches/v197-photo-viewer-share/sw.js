const cacheName = "hp-sofa-catalog-v197-photo-viewer-share";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v197-photo-viewer-share",
  "./app-version.js?v=v197-photo-viewer-share",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v197-photo-viewer-share",
  ...
  "./zolano-visual-overrides.js?v=v197-photo-viewer-share",
  "./chair-data.js?v=2",
