const cacheName = "hp-sofa-catalog-v189-bed-thumb-icons";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v189-bed-thumb-icons",
  "./app-version.js?v=v189-bed-thumb-icons",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v189-bed-thumb-icons",
  ...
  "./zolano-visual-overrides.js?v=v189-bed-thumb-icons",
  "./chair-data.js?v=2",
