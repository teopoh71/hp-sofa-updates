const cacheName = "hp-sofa-catalog-v186-share-select-direct";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v186-share-select-direct",
  "./app-version.js?v=v186-share-select-direct",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v186-share-select-direct",
  ...
  "./zolano-visual-overrides.js?v=v186-share-select-direct",
  "./chair-data.js?v=2",
