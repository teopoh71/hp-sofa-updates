const cacheName = "hp-sofa-catalog-v225-show-armchair-models";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v225-show-armchair-models",
  "./app-version.js?v=v225-show-armchair-models",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v225-show-armchair-models",
  ...
  "./zolano-visual-overrides.js?v=v225-show-armchair-models",
  "./chair-data.js?v=2",
