const cacheName = "hp-sofa-catalog-v1094-zolano3817-selection-fix";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1094-zolano3817-selection-fix",
  "./app-version.js?v=v1094-zolano3817-selection-fix",
  "./app.js?v=v1094-zolano3817-selection-fix",
  "./manifest.json?v=v1094-zolano3817-selection-fix",
  "./assets/app-icon.svg?v=v1094-zolano3817-selection-fix"
];
