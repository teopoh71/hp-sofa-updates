const cacheName = "hp-sofa-catalog-v250-2628-modules-cache-alias-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v250-2628-modules-cache-alias-local",
  "./app-version.js?v=v250-2628-modules-cache-alias-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v250-2628-modules-cache-alias-local",
  ...
  "./zolano-visual-overrides.js?v=v250-2628-modules-cache-alias-local",
  "./chair-data.js?v=2",
