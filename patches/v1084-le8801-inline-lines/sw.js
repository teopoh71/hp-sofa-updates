const cacheName = "hp-sofa-catalog-v1084-le8801-inline-lines";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1068-nk5024-select-both",
  "./app-version.js?v=v1051-37762-photo-fix",
  "./app.js?v=v1084-le8801-inline-lines"
];
