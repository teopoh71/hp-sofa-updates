const cacheName = "hp-sofa-catalog-v261-preview-text-fix-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v261-preview-text-fix-local",
  "./app-version.js?v=v261-preview-text-fix-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v261-preview-text-fix-local",
  ...
  "./zolano-visual-overrides.js?v=v261-preview-text-fix-local",
  "./chair-data.js?v=2",
