const cacheName = "hp-sofa-catalog-v1106-nk0042-half-leather-price";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1106-nk0042-half-leather-price",
  "./app-version.js?v=v1106-nk0042-half-leather-price",
  "./app.js?v=v1106-nk0042-half-leather-price",
  "./manifest.json?v=v1106-nk0042-half-leather-price",
  "./assets/app-icon.svg?v=v1106-nk0042-half-leather-price"
];
