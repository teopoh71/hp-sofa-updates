const cacheName = "hp-sofa-catalog-v985-restore-photo-gallery-assets";
...
const appFiles = [
  ...
  "./styles.css?v=v985-restore-photo-gallery-assets",
  "./app-version.js?v=v985-restore-photo-gallery-assets",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v985-restore-photo-gallery-assets",
  "./assets/individual-item-photos.js?v=v985-restore-photo-gallery-assets",
  ...
  "./zolano-excel-price-overrides.js?v=v985-restore-photo-gallery-assets",
  "./zolano-visual-overrides.js?v=v985-restore-photo-gallery-assets",
  "./chair-data.js?v=2",
  "./bed-data.js?v=125-chinese-materials",
  "./matching-data.js?v=147-bed-size-options",
  "./assets/photo-overrides.js?v=v985-restore-photo-gallery-assets",
  "./assets/photo-gallery.js?v=v985-restore-photo-gallery-assets",
  "./assets/entry-gallery.js?v=v985-restore-photo-gallery-assets",
  "./assets/sofa-asset-gallery.js?v=v985-restore-photo-gallery-assets",
  "./manifest.json",
  "./update.json",
  "./assets/app-icon.svg",
