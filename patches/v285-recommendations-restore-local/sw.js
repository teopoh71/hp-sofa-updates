const cacheName = "hp-sofa-catalog-v995-clearance-button-guard";
...
const appFiles = [
  ...
  "./styles.css?v=v995-clearance-button-guard",
  "./app-version.js?v=v995-clearance-button-guard",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./clearance-data.js?v=v995-clearance-button-guard",
  "./app.js?v=v995-clearance-button-guard",
  "./assets/individual-item-photos.js?v=v995-clearance-button-guard",
  ...
  "./zolano-excel-price-overrides.js?v=v995-clearance-button-guard",
  "./zolano-visual-overrides.js?v=v995-clearance-button-guard",
  "./chair-data.js?v=2",
  "./bed-data.js?v=125-chinese-materials",
  "./matching-data.js?v=147-bed-size-options",
  "./assets/photo-overrides.js?v=v995-clearance-button-guard",
  "./assets/photo-gallery.js?v=v995-clearance-button-guard",
  "./assets/entry-gallery.js?v=v995-clearance-button-guard",
  "./assets/sofa-asset-gallery.js?v=v995-clearance-button-guard",
