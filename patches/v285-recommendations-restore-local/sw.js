const cacheName = "hp-sofa-catalog-v986-module-gallery-photo-fix";
...
const appFiles = [
  ...
  "./styles.css?v=v986-module-gallery-photo-fix",
  "./app-version.js?v=v986-module-gallery-photo-fix",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v986-module-gallery-photo-fix",
  "./assets/individual-item-photos.js?v=v986-module-gallery-photo-fix",
  ...
  "./zolano-excel-price-overrides.js?v=v986-module-gallery-photo-fix",
  "./zolano-visual-overrides.js?v=v986-module-gallery-photo-fix",
  "./chair-data.js?v=2",
  "./bed-data.js?v=125-chinese-materials",
  "./matching-data.js?v=147-bed-size-options",
  "./assets/photo-overrides.js?v=v986-module-gallery-photo-fix",
  "./assets/photo-gallery.js?v=v986-module-gallery-photo-fix",
  "./assets/entry-gallery.js?v=v986-module-gallery-photo-fix",
  "./assets/sofa-asset-gallery.js?v=v986-module-gallery-photo-fix",
  "./manifest.json",
  "./update.json",
  "./assets/app-icon.svg",
