...
async function maybeClearAppCache() {
  ...
  const clearKey = "hp-sofa-cache-cleared-v264";
...
function render() {
  ...
  filtered.forEach((sofa) => {
    ...
    [
      ...
      sofa.priceOptions?.length ? `${sofa.priceOptions.length} ÃƒÂ¤Ã‚Â¸Ã‚ÂªÃƒÂ¦Ã‚ÂÃ‚ÂÃƒÂ¨Ã‚Â´Ã‚Â¨ÃƒÂ¤Ã‚Â»Ã‚Â·ÃƒÂ¦Ã‚Â Ã‚Â¼` : ""
