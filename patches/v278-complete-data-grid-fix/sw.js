const cacheName = "hp-sofa-catalog-v278-complete-data-grid-fix-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v278-complete-data-grid-fix-local",
  "./app-version.js?v=v278-complete-data-grid-fix-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v278-complete-data-grid-fix-local",
  ...
  "./zolano-excel-price-overrides.js?v=v278-complete-data-grid-fix-local",
  "./zolano-visual-overrides.js?v=v278-complete-data-grid-fix-local",
  "./chair-data.js?v=2",
