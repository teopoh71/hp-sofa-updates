const cacheName = "hp-sofa-catalog-v1038-photo-assets-restore-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1038-photo-assets-restore-local",
  "./app-version.js?v=v1038-photo-assets-restore-local",
  "./app.js?v=v1038-photo-assets-restore-local"
];
