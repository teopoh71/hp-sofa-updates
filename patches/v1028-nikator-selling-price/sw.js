const cacheName = "hp-sofa-catalog-v1028-nikator-selling-price";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1028-nikator-selling-price",
  "./app-version.js?v=v1028-nikator-selling-price",
  "./app.js?v=v1028-nikator-selling-price"
];
