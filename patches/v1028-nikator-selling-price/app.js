...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    ...
    navigator.serviceWorker.register("sw.js?v=v1028-nikator-selling-price")
...
async function maybeClearAppCache() {
  ...
  const clearKey = "hp-sofa-cache-cleared-v1028-nikator-selling-price";
