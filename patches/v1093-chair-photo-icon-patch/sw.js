const cacheName = "hp-sofa-catalog-v1093-chair-photo-icon-patch";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1093-chair-photo-icon-patch",
  "./app-version.js?v=v1093-chair-photo-icon-patch",
  "./app.js?v=v1093-chair-photo-icon-patch",
  "./manifest.json?v=v1093-chair-photo-icon-patch",
  "./assets/app-icon.svg?v=v1093-chair-photo-icon-patch"
];
