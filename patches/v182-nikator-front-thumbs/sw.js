const cacheName = "hp-sofa-catalog-vnikator-front-thumbs";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=nikator-front-thumbs",
  "./app-version.js?v=nikator-front-thumbs",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=nikator-front-thumbs",
  ...
  "./zolano-visual-overrides.js?v=nikator-front-thumbs",
  "./chair-data.js?v=2",
