const cacheName = "hp-sofa-catalog-v217-photo-copy-share";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v217-photo-copy-share",
  "./app-version.js?v=v217-photo-copy-share",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v217-photo-copy-share",
  ...
  "./zolano-visual-overrides.js?v=v217-photo-copy-share",
  "./chair-data.js?v=2",
