const cacheName = "hp-sofa-catalog-v1085-cancel-data-updater";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./styles.css?v=v1085-cancel-data-updater",
  "./app-version.js?v=v1085-cancel-data-updater",
  "./app.js?v=v1085-cancel-data-updater"
];
