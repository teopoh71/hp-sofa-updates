const cacheName = "hp-sofa-catalog-v1002-force-manual-patch-check";
...
const appFiles = [
  ...
  "./styles.css?v=v1002-force-manual-patch-check",
  "./app-version.js?v=v1002-force-manual-patch-check",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./clearance-data.js?v=v1002-force-manual-patch-check",
  "./app.js?v=v1002-force-manual-patch-check",
  "./assets/individual-item-photos.js?v=v1002-force-manual-patch-check",
  ...
  "./zolano-excel-price-overrides.js?v=v1002-force-manual-patch-check",
  "./zolano-visual-overrides.js?v=v1002-force-manual-patch-check",
  "./chair-data.js?v=2",
  "./bed-data.js?v=125-chinese-materials",
  "./matching-data.js?v=147-bed-size-options",
  "./assets/photo-overrides.js?v=v1002-force-manual-patch-check",
  "./assets/photo-gallery.js?v=v1002-force-manual-patch-check",
  "./assets/entry-gallery.js?v=v1002-force-manual-patch-check",
  "./assets/sofa-asset-gallery.js?v=v1002-force-manual-patch-check",
