const cacheName = "hp-sofa-catalog-v188-bed-slider-electric";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v188-bed-slider-electric",
  "./app-version.js?v=v188-bed-slider-electric",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v188-bed-slider-electric",
  ...
  "./zolano-visual-overrides.js?v=v188-bed-slider-electric",
  "./chair-data.js?v=2",
