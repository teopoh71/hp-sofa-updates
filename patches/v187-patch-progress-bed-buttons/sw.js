const cacheName = "hp-sofa-catalog-v187-patch-progress";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v187-patch-progress",
  "./app-version.js?v=v187-patch-progress",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v187-patch-progress",
  ...
  "./zolano-visual-overrides.js?v=v187-patch-progress",
  "./chair-data.js?v=2",
