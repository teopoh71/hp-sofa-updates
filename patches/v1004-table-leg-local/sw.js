const cacheName = "hp-sofa-catalog-v1004-table-leg-local";
...
const appFiles = [
  ...
  "./app-version.js?v=v1004-table-leg-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./clearance-data.js?v=v1003-full-apk-clearance",
  "./table-leg-data.js?v=v1004-table-leg-local",
  "./app.js?v=v1004-table-leg-local",
