const cacheName = "hp-sofa-catalog-v271-zl2628-module-line-fix-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v271-zl2628-module-line-fix-local",
  "./app-version.js?v=v271-zl2628-module-line-fix-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v271-zl2628-module-line-fix-local",
  ...
  "./zolano-visual-overrides.js?v=v271-zl2628-module-line-fix-local",
  "./chair-data.js?v=2",
