const cacheName = "hp-sofa-catalog-v191-zolano-chair-buttons";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v191-zolano-chair-buttons",
  "./app-version.js?v=v191-zolano-chair-buttons",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v191-zolano-chair-buttons",
  ...
  "./zolano-visual-overrides.js?v=v191-zolano-chair-buttons",
  "./chair-data.js?v=2",
