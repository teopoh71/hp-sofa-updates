const cacheName = "hp-sofa-catalog-v275-zolano-price-dedupe-photo-hide-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v275-zolano-price-dedupe-photo-hide-local",
  "./app-version.js?v=v275-zolano-price-dedupe-photo-hide-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v275-zolano-price-dedupe-photo-hide-local",
  ...
  "./zolano-excel-price-overrides.js?v=v275-zolano-price-dedupe-photo-hide-local",
  "./zolano-visual-overrides.js?v=v275-zolano-price-dedupe-photo-hide-local",
  "./chair-data.js?v=2",
