const cacheName = "hp-sofa-catalog-v262-zl2628-line-fix-local";
const patchCacheName = "hp-sofa-patch-cache";
const appFiles = [
  "./",
  "./index.html",
  "./photo-viewer.html",
  "./styles.css?v=v262-zl2628-line-fix-local",
  "./app-version.js?v=v262-zl2628-line-fix-local",
  "./mixed-material-pricing.js?v=1",
  "./zolano-3776-layout.js?v=1",
  "./app.js?v=v262-zl2628-line-fix-local",
  ...
  "./zolano-visual-overrides.js?v=v262-zl2628-line-fix-local",
  "./chair-data.js?v=2",
